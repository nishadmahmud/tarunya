...
export default function UpcomingBooks({ products = [] }) {
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <div className="flex items-end justify-between mb-6 md:mb-8">
                    <div>
                        ...
                        <p className="text-xs md:text-sm text-gray-400 hidden sm:block">এই বইগুলো শীঘ্রই আমাদের সংগ্রহে আসছে</p>
                    </div>
                    {products.length > 0 && (
                    ...
                    {products.length > 0 ? (
                        ...
                        <div className="w-full py-12 px-6 rounded-3xl bg-brand-cream/30 border-2 border-dashed border-brand-green/10 flex flex-col items-center justify-center text-center">
                            <div className="w-16 h-16 rounded-full bg-brand-green/5 flex items-center justify-center mb-4">
                                <FiClock className="text-brand-green/40" size={32} />
                            </div>
                            <h3 className="text-lg font-bold text-gray-700 mb-1">এখনো কোনো আসন্ন বই নেই</h3>
                            <p className="text-sm text-gray-400 max-w-xs">খুব শীঘ্রই আমাদের নতুন বইগুলোর তালিকা এখানে পাওয়া যাবে। আমাদের সাথেই থাকুন!</p>
                        </div>
                    )}
                </div>
            </div>
